...
CrossValidator = TypeVar("CrossValidator", bound=BaseCrossValidator)
GroupCrossValidator = TypeVar("GroupCrossValidator", bound=BaseGroupCrossValidator)
GenericCrossValidator = CrossValidator | GroupCrossValidator
